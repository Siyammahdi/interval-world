...
const CARDS = [
  {
    ...
    body: "Interval makes planning your next vacation a breeze. Whether you're still in fact-finding mode and researching potential destinations, or you've found your slice of heaven and are ready to book, intervalworld.com is your starting point! Here's a look at the resources available to you, and just how easy — and fun — it is to plan your next great escape!",
  },
  {
    title: "Interval HD",
    href: "/web/my/channel",
    ...
    body: (
      <>
        Explore destinations and tour resorts before you confirm an exchange or buy a Getaway.{" "}
        <Link href="/web/my/channel" className="text-iw-link underline">
          View videos
        </Link>{" "}
        highlighting vacation experiences around the globe. Plus, watch member videos about Interval
        membership, testimonials, and more.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <Link href="/web/cs/mobile-app" className="font-medium text-iw-link underline">
          Interval International® app
        </Link>{" "}
        now features the ability to exchange from the palm of your hand, using any of your available
        weeks or points. Enjoy a simplified vacation-planning process with just a tap. Check out all
        the other great features included in the app!
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    body: "Connect. Share. Learn. That's the motto of our members-only forum. Explore Community to get exchange tips, travel ideas, and resort details from other members. And, you can share your experiences, even photos, in real time, from anywhere around the world.",
  },
  {
    title: "Interval Travel",
    href: "/web/my/info/planning/travel",
    image: "/images/figma/explore/card-travel.jpg",
    body: "Need air reservations for your next exchange vacation? Want the best deal on a car rental for your upcoming business trip? Dreaming of the perfect cruise and want the best price? We can get you great rates - often unavailable to the general public - on airfares, car rentals, cruises, and more. And with go guided Collette®...",
  },
] as const;
  ...
  return (
    <main id="main-content">
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-8 px-4 pb-12 pt-8 md:px-[120px] md:pb-[50px]">
        ...
        <div className="relative h-[220px] w-full overflow-hidden rounded-[24px] md:h-[378px]">
          <Image
          ...
          {CARDS.map((card) => (
            <article key={card.href + card.title} className="flex flex-col gap-6">
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <h2 className="mb-1 text-[24px] font-medium leading-none text-iw-ink">
                    {card.title}
                  </h2>
